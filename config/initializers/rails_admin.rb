# RailsAdmin config file. Generated on June 17, 2013 10:46
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Fetedelamusique', 'Admin']
  ...
  # config.excluded_models = ['Concert', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Concert', 'User']
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your concert.rb model definition
